...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-478"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-v1",
      "problem_contract_sha256": "3bccc794a3699675db6728d7fb1fd28f18733e0611e36dac06f20c4f9636f295",
      "problem_id": "problem:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82",
      "route_id": "route:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-source-fidelity-01",
      "graph_id": "graph:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Problem Do 4-colorings of $\\mathbb{Z}_{p}$, for $p$ a large prime, always contain a rainbow $AP(4)$ if each of the color classes is of size of either $\\lfloor p/4\\rfloor$ or $\\lceil p/4\\rceil$?"
          },
          "statement_sha256": "9d4845f88988eec6e6c2bd57b7a9d70773d752972fbf79ec4f5989ef3ebb0800"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-root",
      "route_id": "route:um-opg-478-rainbow-ap-4-in-an-almost-equinumerous-5a7bbc82-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-478-720c48aae2a3",
        "url": "https://www.unsolvedmath.com/problems/OPG-478"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
